...
.Étapes
. Dans le widget *Planification*, cliquez sur *Extension de stockage*.
+
...
. Cliquez sur *Envoyer* pour transmettre la demande à l'équipe de stockage NetApp afin qu'elle vous aide à étendre le stockage des systèmes sélectionnés.
