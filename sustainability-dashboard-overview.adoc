...
---
= Découvrez les fonctionnalités du tableau de bord de développement durable dans Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
*Pourcentages de réduction des émissions de carbone* : Affiche le pourcentage de réduction des émissions de carbone pour chaque site/ville, et les valeurs de référence présentées sont basées sur votre localisation. Vous pouvez ajuster le pourcentage de réduction des émissions de carbone pour des sites spécifiques en sélectionnant l’icône image:edit_icon_1.png["Capture d'écran affichant une icône modifiable."] située à côté des valeurs de pourcentage, et les chiffres relatifs aux émissions de carbone seront automatiquement ajustés en conséquence.
