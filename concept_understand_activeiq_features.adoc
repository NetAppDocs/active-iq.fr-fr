...
---
= Découvrez les fonctionnalités de Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
* Consultez le taux de réduction des données, l'espace logique utilisé, l'espace physique utilisé et le volume total de données enregistrées.
...
* link:concept_value_insights.html["Découvrez des informations précieuses"], qui fournit des informations générales sur la santé, les économies, la stabilité et la sécurité de votre système ONTAP.
