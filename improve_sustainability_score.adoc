...
---
= Améliorez le score de durabilité de votre système de stockage grâce à Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
*** Vous pouvez également consulter les actions reportées à tout moment et sélectionner *Considérer* pour les déplacer vers l'onglet *Actions recommandées*. + image:actions_for_later.png["Capture d'écran affichant les actions recommandées avec l'option considérer."]
...
. Sélectionnez le nombre d'actions dans la colonne *Actions recommandées* pour le cluster cible.
+
...
** Si vous sélectionnez *plus tard*, l'action recommandée sélectionnée est déplacée vers l'onglet *actions pour plus tard*. L'action sélectionnée sera reportée de 30 jours. Après 30 jours, cette action passera à l'onglet *actions recommandées*.
** Vous pouvez également consulter à tout moment les actions reportées et sélectionner *Considérer* pour les déplacer vers l'onglet *Actions recommandées*.
