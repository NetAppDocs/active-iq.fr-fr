...
---
= Consultez l'état des clusters et des nœuds à l'aide du widget ClusterViewer dans Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
. Au niveau du cluster ou du nœud, sélectionnez *ClusterViewer* à côté du widget *Configuration*.
. Sélectionnez l'onglet *Visualisation* pour afficher une représentation graphique du cluster.
