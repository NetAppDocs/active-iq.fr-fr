...
---
= Analysez l'état de votre système de stockage grâce aux recommandations cloud de Digital Advisor.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Les volumes répondant aux critères suivants sont recommandés pour la migration vers Cloud Volumes ONTAP (CVO) :
...
.Étapes
. Dans le volet de gauche, sélectionnez *Cloud Recommendations*.
. Sélectionnez un lien quelconque dans le volet *Migration*.
. Sélectionnez *Migrer vers le cloud* pour lancer la *Console*.
...
.Étapes
. Dans le volet de gauche, sélectionnez *Cloud Recommendations*.
. Sélectionnez un lien quelconque dans le volet *Tiering*.
. Sélectionnez *Tier Data* pour lancer la *Console*.
...
.Étapes
. Dans le volet de gauche, sélectionnez *Cloud Recommendations*.
. Sélectionnez un lien quelconque dans le volet *Sauvegarde & Archivage*.
. Sélectionnez *Sauvegarde dans le cloud* pour lancer la *Console*.
...
.Étapes
. Dans le volet de gauche, sélectionnez *Cloud Recommendations*.
. Sélectionnez un lien quelconque dans le volet *Reprise après sinistre*.
. Sélectionnez *Répliquer sur le cloud* pour lancer la *Console*.
