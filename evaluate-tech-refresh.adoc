...
---
= Déterminez si une mise à niveau technologique est recommandée pour votre système de stockage dans Digital Advisor.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Vous pouvez accéder à cette fonctionnalité soit via la planification du cycle de vie (*Stockage* > *Planification du cycle de vie*) soit via Digital Advisor (*Tableau de bord > Widget de planification > Actualisation technique*).
