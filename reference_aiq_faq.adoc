...
. Sélectionnez link:https://mysupport.netapp.com/site/global/dashboard["ici"^] pour ouvrir le site d'assistance NetApp.
. Dans le menu du haut, sélectionnez *My Cases*.
. Sélectionnez *Créer un dossier*.
. Sélectionnez une catégorie, fournissez les détails requis et sélectionnez *Nouvelle recherche* pour rechercher un système dans votre inventaire.
...
. Saisissez la description du problème dans le champ Description du problème et sélectionnez *Procéder*.
. Fournir des détails supplémentaires sur le problème.
. Sélectionnez *Select Files* pour télécharger des fichiers ou des images susceptibles d'aider à diagnostiquer le problème.
...
. Sélectionnez link:https://mysupport.netapp.com/site/help["ici"^] pour ouvrir l’« Outil de commentaires non techniques » sur le site de support NetApp.
...
. Sélectionnez *Storage Efficiency* dans le menu de navigation de gauche.
...
Si vous ne pouvez pas consulter les systèmes pour d'autres raisons, si vous avez des questions ou si vous souhaitez demander un accès, link:https://mysupport.netapp.com/site/help["créer un dossier non technique"^]. Pour en savoir plus sur les cas non techniques, sélectionnez <<Cas non technique,ici.>>
