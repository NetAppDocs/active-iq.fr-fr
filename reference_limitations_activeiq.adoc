...
---
= Limitations connues de Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Sur la page de rapports AutoSupport, la sélection de l’un des statuts, des systèmes qui ont récemment cessé d’envoyer des données ou des systèmes pour lesquels AutoSupport est désactivé ne permet pas d’accéder à l’écran de vérification de l’état.
