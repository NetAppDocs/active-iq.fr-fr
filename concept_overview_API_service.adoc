...
---
= Découvrez les services API de Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Les deux affichages permettent à l'utilisateur de parcourir les éléments disponibles à l'aide du volet de navigation situé à gauche. Les éléments sont organisés par service, par ordre alphabétique. Au sein d'un service donné, vous pouvez développer l'en-tête pour afficher les points de terminaison API individuels. La sélection de l'en-tête du service ou d'un point de terminaison API vous amènera à cette section du catalogue dans le volet central.
...
Pour savoir comment accéder et utiliser les API de Digital Advisor, consultez link:https://docs.netapp.com/us-en/digital-advisor-automation/["NetApp Digital Advisor documentation de l'API"].
