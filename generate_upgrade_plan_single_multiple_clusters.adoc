...
* Assurez-vous que AutoSupport (ASUP) est activé et correctement configuré, et que toutes les sections requises sont incluses. Pour plus d'informations, voir link:hhttps://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-KBs/ONTAP_AutoSupport_Resolution_Guide["Guide de résolution ONTAP AutoSupport"].
