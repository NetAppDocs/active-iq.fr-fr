...
*Pourquoi ne puis-je pas trouver certains systèmes dans la page d'inventaire?* il se peut que vous ne puissiez pas voir certains systèmes dans la page d'inventaire en raison de l'une des raisons suivantes :
...
* Les systèmes sont inactifs ou désaffectés dans SAP.


Si vous ne parvenez pas à afficher les systèmes pour d'autres raisons, link:https://mysupport.netapp.com/site/help["créer un dossier non technique"]. Pour en savoir plus sur un dossier non technique, cliquez sur <<Cas non technique,ici.>>
