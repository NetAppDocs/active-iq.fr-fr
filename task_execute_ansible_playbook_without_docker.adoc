...
---
= Exécutez le playbook Ansible sans l'image Docker NetApp.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
----
+
Pour plus d'informations sur la commande ansible-galaxy, consultez link:https://docs.ansible.com/projects/ansible/latest/cli/ansible-galaxy.html["Documentation Ansible Galaxy"^] et pour plus d'informations sur la collection Ansible NetApp, consultez link:https://galaxy.ansible.com/netapp/ontap["Page de collecte NetApp Ansible"^].
