...
---
= Utilisez Digital Advisor pour corriger les risques critiques identifiés dans le widget Disponibilité et Protection
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
. Sélectionnez *Actions* dans le widget *Disponibilité et protection*.image:Availability and protection_image 1 downtime and data loss.png["Widget de disponibilité et de protection"]
+
...
. Sélectionnez le lien *Nom du risque* pour consulter le résumé du risque. image:Risk summary_image 2 downtime and data loss.png["Résumé des risques"]
. Sélectionnez l'onglet *Risques uniques*, puis sélectionnez le lien dans la colonne *Mesures correctives*. image:Corrective action_image 3 downtime and data loss.png["Action corrective"]
+
...
. Sélectionnez l’icône *Ansible “A”* pour générer et télécharger les scripts. image:Update AFF and FAS Firmware_image 4 downtime and data loss.png["Firmwares des disques AFF et FAS"]
