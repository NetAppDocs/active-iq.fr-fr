...
---
= Utilisez Digital Advisor pour consulter les données des machines virtuelles disponibles dans Data Infrastructure Insights.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
.Étapes
. Dans le widget *Inventaire*, sélectionnez *Machines virtuelles* pour afficher les données disponibles dans Data Infrastructure Insights.
. Sélectionnez l'onglet *Aperçu de la machine virtuelle*.
. Sélectionnez le *Nombre d'hôtes ESX* pour afficher les informations relatives à l'hôte.
. Sélectionnez le *nom ESX* pour accéder à Data Infrastructure Insights afin d'afficher plus d'informations.
