...
---
= Termes et définitions clés dans Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
** *Correction* : Corrige les risques liés au système à l’aide d’Active IQ Unified Manager. Sélectionnez ce bouton pour lancer Unified Manager et effectuer les étapes permettant de corriger les risques.
...
* *Widget de planification :* Affiche des informations sur l’extension de stockage, les logiciels et le matériel qui doivent être renouvelés.
+
** *Extension du stockage :* Identifie les systèmes ayant dépassé ou approchant 90 % de leur capacité et les sites GRID ayant dépassé ou approchant 70 % de leur capacité. Vous pouvez soumettre une demande d’augmentation de la capacité de votre système de stockage.
** *Renouvellements de support :* Fournit des informations sur les logiciels et le matériel dont le support a expiré ou arrive à expiration dans les 6 prochains mois.
...
* *Efficacité du stockage :* Identifie le taux d’efficacité du stockage et les économies réalisées par votre système de stockage avec et sans copies instantanées pour les systèmes AFF, les systèmes non-AFF ou les deux.
...
* *Services API :* Permet d’extraire des données pertinentes et de les intégrer directement dans le flux de travail de votre entreprise.
...
* *Client :* Permet de consulter et de gérer la base client installée d’un client. Le tableau de bord client est le portail central de Digital Advisor.
